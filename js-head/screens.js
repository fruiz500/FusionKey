...
//		showLockBtn.textContent = 'Email';					//no email function in FusionKey
...
function main2lock(){
	...
	if(string == '') addLockBtn.textContent = "Random";
	resetList();
	openClose('lockScr');
	openClose('shadow');
	focusBox()
...
function showTab(){
	...
	if(passLok.style.display == 'block'){  
