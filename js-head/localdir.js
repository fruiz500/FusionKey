...
function mergeLockDB(){
	callKey = 'mergedb';
	var lockstr = lockBox.innerText.trim();				//innerText so linefeeds are recognized as \n
...
function moveLockDB(){
	...
	lockNames = [];
	chrome.runtime.sendMessage({message: "reset_now"});			//remove data from background page
